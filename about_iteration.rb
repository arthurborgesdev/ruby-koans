...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ### Starts with the first argument equals the first parameter of the block, and the second one being the another one, then goes 
    ### applying the function and saving the result in the first parameter of the block, until the array ends
    ### The result is the final value of this parameter.
  end
  ...
  #   end
  #
  # Why did we do it that way instead of the following? ### => Async vs Sync
  #
